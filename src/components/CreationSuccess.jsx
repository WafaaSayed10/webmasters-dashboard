    ...
    return(
        ...
        <main className='h-[600px]'>
            <section className="bg-[#13131F] p-3 w-[85%] md:w-[70%] h-[85%] md:h-[80%] m-10 flex flex-col justify-between items-center">
                <Link to={"/products"} className='self-end border rounded-full border-[#fff] w-fit text-[25px]'><IoCloseOutline className='text-[#fff]' /></Link>
                ...
                <div className='flex flex-col gap-[15px] w-full items-center mb-[30px]'>
                    ...
                    <Link to={"/products"} className='rounded-md text-center capitalize w-2/3 md:w-1/3 p-[3px] text-[#fff] bg-green-600'>close</Link>
                </div>
            </section>
        </main>
        </>
