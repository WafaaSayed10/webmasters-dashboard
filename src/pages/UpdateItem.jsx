...
export default function UpdateItem() {
  ...
  const handleSubmit = async (e) => {
      ...
      try{
        const response =  await updateDoc(doc(db, "products" , id) , formData);
          ...
          <div className="bg-[#13131F] text-white w-full max-w-5xl p-6 md:p-10 rounded-md grid grid-cols-1 md:grid-cols-3 gap-8 relative min-h-[500px]">
            ...
            <div className="flex flex-col justify-between col-span-1">
              ...
              <div className="flex flex-col gap-3 ">
                <Link to={"/"} className="w-full text-center px-6 py-2 text-white bg-transparent border rounded-md text-[18px] border-green-600">
                  Cancel
                </Link>
